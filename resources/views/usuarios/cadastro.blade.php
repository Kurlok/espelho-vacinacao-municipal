                        ...
                        <form method="POST" action="{{route('cadastrarUsuario')}}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="@if(isset($usuario)){{$usuario->name}}@endif" required autocomplete="name" autofocus>
                                    @error('name')
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="cpf" type="text" class="form-control @error('cpf') is-invalid @enderror" name="cpf" value="@if(isset($usuario)){{$usuario->cpf}}@endif" required autocomplete="cpf" autofocus @if(isset($usuario)) disabled @endif>
                                    @error('cpf')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="@if(isset($usuario)){{$usuario->email}}@endif" required autocomplete="email" @if(isset($usuario)) disabled @endif>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="funcao" type="text" class="form-control @error('funcao') is-invalid @enderror" name="funcao" value="@if(isset($usuario)){{$usuario->funcao}}@endif" required autocomplete="funcao" autofocus>
                                    @error('funcao')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="unidade" type="unidade" class="form-control @error('unidade') is-invalid @enderror" name="unidade" value="@if(isset($usuario)){{$usuario->unidade}}@endif" required autocomplete="unidade">
                                    @error('unidade')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
