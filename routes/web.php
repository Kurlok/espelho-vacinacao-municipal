...
Route::middleware(['auth', 'Administrador', 'SenhaRedefinida'])->group(function () {
    ...
    Route::get('/relatorios/vacinas/especifica', 'RelatoriosController@exportarVacinaEspecifica')->name('relatorioVacinaEspecifica');
    Route::get('/relatorios/vacinas/pendente', 'RelatoriosController@exportarVacinasPendentes')->name('relatorioVacinaPendente');
